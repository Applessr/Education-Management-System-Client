...
export const getMajorById = (facultyId) =>
  axios.get("/course/major/" + facultyId);

export const getCourseBySearch = (searchQuery) =>
  axios.get(`/course/all-course?searchTerm=${searchQuery}`);

export const getCourseById = (courseId) =>
  axios.get("/course/all-course/" + courseId);

export const studentGetCourseSyllabus = (token) =>
  axios.get("/course/student/course-syllabus", {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });

export const studentGetEnrollCourse = (token) =>
  axios.get("/course/student/enroll-course", {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });

export const teacherGetCourse = (token) =>
  axios.get("/course/teacher", {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });

export const studentGetEnrollCourseBySemester = (token, body) =>
  axios.post("/course/student/enroll-course-semester", body, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export const studentSendEnrollRequest = (token, body) =>
  axios.post("/course/student/enroll-course", body, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
...
export const employeeEditCourse = (token, courseId, body) =>
  axios.patch(`/course/employee/edit-course/${courseId}`, body, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
