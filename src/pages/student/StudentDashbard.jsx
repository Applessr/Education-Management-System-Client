...
const StudentDashboard = () => {
  ...
  const progressPercentage =
    (student.credits.completed / student.credits.total) * 100;
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <p className="text-sm font-medium">
                    {student.credits.completed}/{student.credits.total} Credits
                  </p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="bg-blue-100 p-4 rounded-lg">
                  ...
                  <p className="font-bold text-[#1A237E]">
                    {student.mainSubjects.remaining}/
                    {student.mainSubjects.total}
                  </p>
                </div>
                ...
                <div className="bg-blue-50/50 p-4 rounded-lg">
                  ...
                  <p className="text-blue-700">Summary:</p>
                  <p className="font-bold text-[#1A237E]">
                    {student.optionalSubjects.remaining}/
                    {student.optionalSubjects.total}
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex justify-around items-center">
              <div>
                <img
                  src="https://res.cloudinary.com/djudr1vzc/image/upload/v1730954704/student_Women_icon_lzt9mr.png"
                  alt="student-image"
                  className="w-[130px]"
                />
              </div>
                        ...
                        {semesterData?.courses?.map((course, courseIndex) => (
                          <tr key={courseIndex} className="border-b">
                            ...
                            <button
                              ...
                              className="btn bg-[#008CCD] text-white my-2"
                            >
                              View
                            </button>
                          </tr>
