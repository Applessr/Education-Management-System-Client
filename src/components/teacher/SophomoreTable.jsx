    ...
    header: ({ column }) => {
      return (
        <Button
          variant="ghost"
          onClick={() =>
            column.toggleSorting(column.getIsSorted() === "mobile")
          }
        >
          Mobile
          <CaretSortIcon className="ml-2 h-4 w-4" />
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <Button
          variant="ghost"
          onClick={() => column.toggleSorting(column.getIsSorted() === "CPA")}
        >
          CPA
          <CaretSortIcon className="ml-2 h-4 w-4" />
        </Button>
  ...
  return (
    <div>
      <div>
        ...
        <p className="bg-orange-300">Sophomore</p>
      </div>
